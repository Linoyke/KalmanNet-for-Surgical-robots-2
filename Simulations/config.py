...
def general_settings():
    ...
    parser.add_argument('--to_center_trajs', type=bool, default=False, metavar='centering_traj_flag',
                        help='flag to note if centering the trajectories by their mean is required.')
    ...
    parser.add_argument('--n_steps_EKF', type=int, default=20, metavar='N_steps_EKF',
                    help='number of EKF training steps (default: 20)')
    ...
    parser.add_argument('--CompositionLoss2', type=bool, default=False, metavar='loss',
                        help='if True, use composition loss number 2')
